  ...
  return (
    <div className="font-onest bg-gris3 flex flex-col min-h-screen pt-3">
      ...
      <div className="bg-white shadow-lg rounded-3xl border-b-2 p-2 w-[90%] max-w-[1400px] my-8 ml-[5%]">
        <div className="w-full border-collapse bg-white rounded-xl my-2">
          <table className="min-w-full">
            <thead>
              <tr className="bg-white">
                <th className="font-onest font-semibold text-negro  text-2xl p-2 pt-4">
                  Tipo
                </th>
                <th className="font-onest font-semibold text-negro  text-2xl p-2 pt-4">
                  Monto

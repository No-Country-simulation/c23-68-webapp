      ...
      <div className='bg-white shadow-lg rounded-3xl border-b-8  border-r-8 border-l-2 border-t-2 border-black py-12 p-24 w-[89%] max-w-[1400px] my-16 mx-auto'>
        <div className='text-center'>
          ...
          <p className='max-w-4xl pt-1 mx-auto mt-4 text-base font-normal font-onest text-negro'>
            En Logo Finanzas, estamos orgullosos de presentar al equipo que
            convirtió esta idea en realidad. Somos un grupo multidisciplinario
            de desarrolladores y diseñadores que compartimos una visión común:
            ayudarte a tomar el control de tus finanzas de manera sencilla y
            eficiente. Cada detalle, desde el diseño de la plataforma hasta las
            funcionalidades que utilizas, es el resultado del esfuerzo, la
            creatividad y la pasión de nuestro equipo. Conoce a las personas que
            hicieron esto posible y descubre cómo trabajamos para brindarte una
            experiencia única.
          </p>
        </div>
        {/*

      ...
      <div className="bg-white shadow-lg rounded-3xl border-b-8 border-r-8 border-l-2 border-t-2 border-black py-6 px-56 w-[89%]  max-w-[1400px] h-auto my-16 mx-auto">
        <div className="text-center ">
          ...
          <h2 className="text-3xl font-anybody font-bold text-negro my-4">
            La Regla del 50/30/20: La Estrategia Simple para Administrar tu
            Dinero
          </h2>

          <p className=" text-left text-lg text-black font-light font-onest">
            Administrar el dinero puede parecer complicado, pero la regla del
            50/30/20
          ...
          <h3 className="text-left text-lg text-black font-light font-onest my-4">
            Esta estrategia propone dividir los ingresos mensuales en tres
            categorías:
          </h3>
          <ol className="text-left text-lg text-black font-bold font-onest list-decimal list-inside">
            <li>50% para necesidades</li>
            <h3 className="text-left text-lg text-black font-light font-onest my-4 ">
              Este porcentaje se destina a los gastos básicos e imprescindibles,
              como:
            </h3>
            ...
            <h3 className="text-left text-lg text-black font-light font-onest my-4">
              Si estos gastos superan el 50% del ingreso, es recomendable buscar
              formas de reducirlos, como mudarse a un lugar más económico o
              renegociar contratos de servicios.
            </h3>
            <li>30% para deseos y estilo de vida</li>
            <h3 className="text-left text-lg text-black font-light font-onest my-4">
              Aquí entran los gastos que no son esenciales, pero que hacen la
              vida más agradable:
            </h3>
            <ul className="text-left text-lg text-black font-light font-onest list-disc list-inside">
            ...
            <h3 className="text-left text-lg text-black font-light font-onest my-4">
              Este porcentaje permite disfrutar de la vida sin afectar la
              estabilidad financiera.
            </h3>
            <li>20% para ahorro e inversión</li>
            <h3 className="text-left text-lg text-black font-light font-onest my-4">
              Este es el porcentaje destinado a construir un futuro financiero
              sólido. Incluye:
            </h3>
            <ul className="text-left text-lg text-black font-light font-onest list-disc list-inside">
            ...
            <h3 className="text-left text-lg text-black font-light font-onest my-4">
              Siguiendo esta regla, se logra un equilibrio entre cubrir
              necesidades, disfrutar el presente y asegurar el futuro
              financiero.
            </h3>
          </ol>
        </div>

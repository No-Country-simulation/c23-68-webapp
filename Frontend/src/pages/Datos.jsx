...
const Datos = () => {
  return (
    <div className="font-sans bg-gris3 min-h-screen pt-6">
      ...
      {/* Botón "Agregar datos" */}
      <div className="flex justify-end pl-[30%] pt-6 pb-6 w-auto">
        <button className="flex items-center justify-center mx-16 px-6 py-3 gap-4  bg-green-500 font-onest text-white text-xl rounded-full shadow-lg hover:bg-green-600">
          <svg
            width="17"
            height="16"
            viewBox="0 0 17 16"

...
const DataTable = ({ data = [] }) => {
  ...
  const Badge = ({ variant, children }) => {
    ...
    return (
      <span
        className={`inline-block px-2 py-1 rounded-full text-sm font-semibold ${colorClass}`}
      >
        {children}
      </span>
    )
  ...
  return (
    <div className='w-full p-10 text-lg font-normal bg-gray-200 font-onest'>
      <div className='flex justify-between mb-4'>
        ...
        <select
          ...
          className='p-2 mb-4 font-bold border rounded-lg text-gris2'
        >
      ...
      <div className='flex items-center justify-between mb-4'>
        ...
        <button
          className='flex items-center gap-2 px-6 py-2 text-white rounded-lg bg-verde'
          onClick={handleClick}
        >
          <svg
            width='20'
        ...
        <tbody>
          {currentItems.map((data) => (
            <tr key={data.id}>
              ...
              <td className='p-2 pb-4 text-center'>{data.Objetivo}</td>
              <td className='p-2 pb-4 text-center'>${data.Monto}.00</td>
              <td className='p-2 pb-4 text-center'>{data.fecha_inicio}</td>
              <td className='p-2 pb-4 text-center'>{data.fecha_fin}</td>
              <td className='flex justify-center gap-2 p-2 pb-4'>
                <button className='flex items-center gap-2 px-2 py-1 text-white bg-yellow-500 rounded'>
                  <svg
                    width='21'
                    height='20'
                    viewBox='0 0 21 20'

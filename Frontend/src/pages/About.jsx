    ...
    <div className='min-h-screen font-sans bg-white'>
      <div className='bg-white shadow-lg rounded-3xl border-b-8  border-r-8 border-l-2 border-t-2 border-black py-12 p-24 w-[89%] max-w-[1400px] my-16 mx-auto'>
        <img
          ...
          alt=''
          className='absolute w-20 h-20 top-50 left-96'
        />
        <img
          src='https://images.emojiterra.com/microsoft/fluent-emoji/15.1/1024px/1f4b8_color.png'
          alt=''
          className='absolute w-20 h-20 top-50 right-96'
        />
        <div className='text-center'>
          <button className='py-2 text-xl font-normal border border-black rounded-full bg-verdeclaro font-onest px-7 '>
            Acerca de
          </button>
        ...
        <div className='grid grid-cols-1 gap-24 mt-5 mr-6 md:grid-cols-2 lg:grid-cols-4 max-w-7xl'>
          <div className='relative flex flex-col items-center justify-between py-6 pl-3 -mx-10 text-left duration-200 ease-in shadow-lg hover:scale-105 bg-verdesemioscuro rounded-2xl hover:shadow-verdesemioscuro my-7'>
            ...
            <svg
              ...
              className='absolute ml-56 -mt-36 '
            >
              <path
          ...
          <div className='relative flex flex-col items-center justify-between py-6 pl-3 -mx-10 text-left duration-200 ease-in shadow-lg hover:scale-105 bg-amarillo rounded-2xl hover:shadow-amarillo my-7'>
            <h3 className='ml-2 mr-24 text-2xl font-semibold leading-6 text-negro font-anybody'>
            ...
            <svg
              ...
              fill='none'
              xmlns='http://www.w3.org/2000/svg'
              className='absolute right-0 mt-3 mr-4 top-5'
            >
              <path
          ...
          <div className='relative flex flex-col items-center justify-between py-6 pl-3 my-6 -mx-10 text-left duration-200 ease-in shadow-lg  hover:scale-105 bg-rosa rounded-2xl hover:shadow-rosa'>
            <h3 className='ml-2 mr-24 text-2xl font-semibold leading-6 text-negro font-anybody'>
          ...
          <div className='relative flex flex-col items-center justify-between py-6 pl-3 my-6 -mx-10 text-left duration-200 ease-in shadow-lg hover:scale-105 bg-celeste rounded-2xl hover:shadow-celeste'>
            <h3 className='ml-2 mr-24 text-2xl font-semibold leading-6 text-negro font-anybody'>
        ...
        <div className='flex flex-row mt-5 -ml-8 gap-14'>
          ...
          >
            ...
            <svg
              ...
              fill='none'
              xmlns='http://www.w3.org/2000/svg'
              className='relative bottom-14 -right-96 '
            >
              <path

    ...
    <div className="min-h-screen font-sans bg-white">
      <div className="bg-white shadow-lg rounded-3xl border-b-8 border-r-8 border-l-2 border-t-2 border-black py-6 px-56 w-[89%]  max-w-[1400px] h-auto my-16 mx-auto">
        <div className="text-center ">
          ...
          Cómo la Planificación Financiera Ayuda a Evitar el Estrés Financiero y Alcanzar Metas a Largo Plazo
          </h2>

          <p className=" text-left text-lg text-black font-light font-onest">
          El estrés financiero es una de las principales fuentes de preocupación en la vida de muchas personas. No saber si el dinero alcanzará para cubrir necesidades, pagar deudas o enfrentar imprevistos
            <span className="font-onest  font-bold text-lg text-blue-500">
              {" "}
              puede generar ansiedad y afectar la calidad de vida.
              {" "}
            </span>
            La planificación financiera es la clave para tomar el control de nuestras finanzas y construir un futuro estable.
          </p>
          ...
          <ol className="text-left text-lg text-black font-bold font-onest list-decimal list-inside">
            ...
            <p className="text-left text-lg text-black font-light font-onest ">
            Elaborar un presupuesto mensual permite saber cuánto dinero entra y en qué se está gastando. Esto ayuda a identificar gastos innecesarios y a distribuir mejor los ingresos.
            </p>
            <li>Reducción de deudas</li>
            <p className="text-left text-lg text-black font-light font-onest ">
            Tener un plan de pago organizado evita caer en el ciclo de deudas que generan altos intereses y estrés constante. Priorizar la eliminación de deudas costosas mejora la estabilidad financiera.
            </p>
            <li>Creación de un fondo de emergencia</li>
            <p className="text-left text-lg text-black font-light font-onest ">
            Contar con un ahorro destinado a imprevistos (como emergencias médicas o reparaciones del hogar) evita la necesidad de recurrir a préstamos o tarjetas de crédito.
            </p>
            <li>Definición de metas a largo plazo</li>
            <p className="text-left text-lg text-black font-light font-onest ">
            Ahorrar sin un propósito puede ser difícil. Definir objetivos concretos, como comprar una casa, estudiar una maestría o jubilarse cómodamente, motiva a mantener una planificación financiera constante.
            </p>
          </ol>
          <p className=" text-left text-lg text-black font-light font-onest my-4">
          Cuando tomamos el control de nuestras finanzas, reducimos la incertidumbre y podemos enfocarnos en disfrutar la vida sin preocupaciones innecesarias.
          </p>
        </div>
        {/* Slider */}
        <div className="mt-10">

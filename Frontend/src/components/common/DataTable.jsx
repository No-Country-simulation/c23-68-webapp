...
const DataTable = ({ data }) => {
  ...
  const { AhorrosFormModalID, DatosEliminadosModalID, AhorrosEditFormModalID } =
    nameModal
  ...
  return (
    <div className='w-full p-10 text-lg font-normal bg-gris3 font-onest'>
      ...
      <div className='flex items-center justify-between mb-4'>
        ...
        <button
          className='flex items-center gap-2 px-6 py-2 text-white rounded-lg shadow-lg bg-verde hover:bg-verdeoscuro'
          onClick={handleClick}
        >
          <svg
            width='20'
      ...
      <table className='w-full bg-white border-collapse shadow-lg rounded-xl'>
        <thead>

        ...
        <ul className='px-5 space-y-6'>
          ...
          <li>
            ...
            >
              ...
              >
                <path
                  d='M15.5909 4.47537L19.5197 8.39635M17.2575 2.81206C17.7785 2.29211 18.4851 2 19.2219 2C19.9587 2 20.6653 2.29211 21.1863 2.81206C21.7073 3.33201 22 4.03722 22 4.77255C22 5.50787 21.7073 6.21308 21.1863 6.73304L5.88882 22H2V18.0391L17.2575 2.81206Z'
                  stroke='#1E1E1E'
                  stroke-width='2'
                  stroke-linecap='round'
                  stroke-linejoin='round'
          ...
          <li>
            ...
            >
              ...
              >
                ...
                />
                <path
                  d='M16.682 15.682C17.5259 14.8381 18 13.6935 18 12.5C18 11.3065 17.5259 10.1619 16.682 9.31802C15.8381 8.47411 14.6935 8 13.5 8C12.3065 8 11.1619 8.47411 10.318 9.31802C9.47411 10.1619 9 11.3065 9 12.5C9 13.6935 9.47411 14.8381 10.318 15.682C11.1619 16.5259 12.3065 17 13.5 17C14.6935 17 15.8381 16.5259 16.682 15.682Z'
                  stroke='#1E1E1E'
                  stroke-width='2'
                  stroke-linecap='round'
                  stroke-linejoin='round'

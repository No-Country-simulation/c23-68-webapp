      ...
      <nav>
        ...
        <li>       
          ...
          <li>
            ...
            className="inline-block mr-3"
            width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M15.5909 4.47537L19.5197 8.39635M17.2575 2.81206C17.7785 2.29211 18.4851 2 19.2219 2C19.9587 2 20.6653 2.29211 21.1863 2.81206C21.7073 3.33201 22 4.03722 22 4.77255C22 5.50787 21.7073 6.21308 21.1863 6.73304L5.88882 22H2V18.0391L17.2575 2.81206Z" stroke="#1E1E1E" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
              Datos
            </NavLink>
          </li>
